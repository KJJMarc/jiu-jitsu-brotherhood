...
const introTeaching = {
  src: "/images/jjb/about-intro-teaching.jpg",
  alt: "Instructor teaching Brazilian Jiu Jitsu on the mats",
  width: 1024,
  height: 683,
  position: "center 40%",
} as const;
      ...
      >
        <div className={`container ${styles.split} ${styles.splitMediaFirst}`}>
          ...
          <div className={styles.media}>
            <Image
              src={introTeaching.src}
              alt={introTeaching.alt}
              fill
              priority
              ...
              style={{
                objectFit: "cover",
                objectPosition: introTeaching.position,
              }}
            />
          </div>
        </div>
